...
class gMessageViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var apiToken = datadef.object(forKey: "studentToken")
    ...
    @IBAction func reloadaction(sender: AnyObject) {
        TableData.removeAll()
        get_data_from_url(url: gmessageurl)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if Reachability.isConnectedToNetwork() == true {
            ...
            loadgmessagefromcoredata()
            
            clearCoreData(entity: "Gmessage")
    ...
    func extract_json(jsonData:NSData)
    {
            ...
            //if let json:AnyObject = NSJSONSerialization.JSONObjectWithData(jsonData, options: nil)
        {
            ...
            let gmessage: NSArray = list["message"]! as! NSArray
            // let coverimage:NSArray = list["coverimage"] as! NSArray
            //print(coverimage)
            
            for messages in gmessage{//
    ...
    func store (dataset: datastruct) {
        ...
        //2
        let newdata = NSEntityDescription.insertNewObject(forEntityName: "Gmessage", into: context) as NSManagedObject
    ...
    func loadgmessagefromurl(){
        get_data_from_url(url: "\(gmessageurl)\(apiToken!)")
        
    }
    func loadgmessagefromcoredata(){
        ...
        fetchRequest.entity = NSEntityDescription.entity(forEntityName: "Gmessage", in: context)
